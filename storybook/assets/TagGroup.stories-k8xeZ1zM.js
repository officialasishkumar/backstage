...
@public`,methods:[],displayName:"Tag",props:{icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The icon to display in the chip."},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"}]},description:"The size of the chip."},href:{required:!1,tsType:{name:"ReactAriaTagProps['href']",raw:"ReactAriaTagProps['href']"},description:""},children:{required:!1,tsType:{name:"ReactAriaTagProps['children']",raw:"ReactAriaTagProps['children']"},description:""},className:{required:!1,tsType:{name:"string"},description:""},noTrack:{required:!1,tsType:{name:"boolean"},description:""}},composes:["Omit"]};const C=mt.meta({title:"Backstage UI/TagGroup",component:S,argTypes:{selectionMode:{control:{type:"inline-radio"},options:["single","multiple"]},"aria-label":{control:{type:"text"}}},decorators:[i=>u.jsx(Jt,{children:u.jsx(Qt,{children:u.jsx(i,{})})})]}),L=[{id:"banana",name:"Banana",icon:u.jsx(ae,{})},{id:"apple",name:"Apple",icon:u.jsx(bt,{}),isDisabled:!0},{id:"orange",name:"Orange",icon:u.jsx(oe,{}),isDisabled:!0},{id:"pear",name:"Pear",icon:u.jsx(se,{})},{id:"grape",name:"Grape",icon:u.jsx(ae,{})},{id:"pineapple",name:"Pineapple",icon:u.jsx(oe,{})},{id:"strawberry",name:"Strawberry",icon:u.jsx(se,{})}],D=C.story({args:{"aria-label":"Tag Group"},render:i=>u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{children:e.name},e.id))})}),K=C.story({args:{...D.input.args},render:i=>u.jsxs(Zt,{direction:"column",children:[u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{size:"small",icon:e.icon,children:e.name},e.id))}),u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{size:"medium",icon:e.icon,children:e.name},e.id))})]})}),R=C.story({args:{selectionMode:"single","aria-label":"Tag Group"},render:i=>{const[e,r]=g.useState(new Set(["travel"]));return u.jsx(S,{...i,items:L,selectedKeys:e,onSelectionChange:r,children:a=>u.jsx(k,{children:a.name})})}}),M=C.story({args:{selectionMode:"multiple","aria-label":"Tag Group"},render:i=>{const[e,r]=g.useState(new Set(["travel","shopping"]));return u.jsx(S,{...i,items:L,selectedKeys:e,onSelectionChange:r,children:a=>u.jsx(k,{children:a.name})})}}),G=C.story({args:{...D.input.args},render:i=>u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{icon:e.icon?e.icon:void 0,children:e.name},e.id))})}),I=C.story({render:i=>u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{href:`/items/${e.id}`,children:e.name},e.id))})}),j=C.story({render:i=>u.jsx(S,{...i,children:L.map(e=>u.jsx(k,{isDisabled:e.isDisabled,children:e.name},e.id))})}),z=C.story({args:{...D.input.args},render:i=>{const[e,r]=g.useState(new Set(["travel"])),a=at({initialItems:L});return u.jsx(S,{...i,items:a.items,onRemove:o=>a.remove(...o),selectedKeys:e,onSelectionChange:r,children:o=>u.jsx(k,{children:o.name})})}}),N=C.story({args:{...D.input.args},render:i=>{const[e,r]=g.useState(new Set(["travel"])),a=at({initialItems:L});return u.jsx(S,{...i,items:a.items,onRemove:o=>a.remove(...o),selectedKeys:e,onSelectionChange:r,children:o=>u.jsx(k,{icon:o.icon?o.icon:void 0,children:o.name})})}});D.input.parameters={...D.input.parameters,docs:{...D.input.parameters?.docs,source:{code:`const Default = () => (
