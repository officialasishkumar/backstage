import{r as a,j as i}from"./iframe-BHNZ12cl.js";import{e as y,a as f}from"./routes-wgZ3psvF.js";import{L as m}from"./Link-DlpkdDiW.js";import{u as g}from"./useRouteRef-Dhq0qgqG.js";import{E as b}from"./EntityDisplayName-B3bW7HyQ.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(b,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(m,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=g(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
