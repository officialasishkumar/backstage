import{r as j,j as a,N as X,a2 as Y,P}from"./iframe-hebBxzMS.js";import{s as Z,M as ee}from"./api-jc-W2kkT.js";import{l as ne}from"./lodash-Dh4D4KP7.js";import{a as ae}from"./useAsync-DBxU8MB7.js";import{u as te}from"./useDebounce-KlKLjyE6.js";import{u as _,S as re}from"./SearchContext-DrQAi7yW.js";import{A as se}from"./Autocomplete-D35blkP6.js";import{C as le}from"./Chip-YpSJO-GT.js";import{T as ie}from"./TextField-B94sBlAb.js";import{s as ue}from"./translation-WMSPag9l.js";import{m as oe}from"./makeStyles-BuKfj6eo.js";import{a as G,F as ce}from"./FormLabel-CpSu2UiP.js";import{F as me}from"./FormControlLabel-M0kZ3x7H.js";import{C as pe}from"./Checkbox-BdfCfx0r.js";import{S as de}from"./Select-CFSLc99W.js";import{S as B}from"./Grid-DR9XAO4b.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-DnJagaLH.js";import"./useMountedState-BOTwgk6q.js";import"./Popper-Nu0-WiMx.js";import"./Portal-DVg2kjtj.js";import"./ListSubheader-B88gq6bL.js";import"./Select-CX3j3K8s.js";import"./index-B9sM2jn7.js";import"./Popover-BcCigjgZ.js";import"./Modal-D8j_BW28.js";import"./List-B-7FtQra.js";import"./ListContext-vEx_JeiU.js";import"./formControlState-DutHjy-Z.js";import"./InputLabel-CzP71cpe.js";import"./SwitchBase-jFAA_ETX.js";import"./Cancel-BEvVWoaw.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-CsMG6Ed5.js";import"./styled-eU63C66P.js";import"./MenuItem-CaZu7W5j.js";import"./ListItem-B2Xdmbv7.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ve(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let W;const ge=new Uint8Array(16);function fe(){if(!W){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");W=crypto.getRandomValues.bind(crypto)}return W(ge)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ve(t)}function x(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>x(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=j.useRef({}),u=j.useCallback(async o=>(await e?.(o))?.map(S=>x(S))||[],[e]),[q,p]=ae(u,[n],{loading:!0});if(te(()=>{r.current[n]===void 0&&(r.current[n]=p(n).then(o=>(r.current[n]=o,o)))},t,[p,n]),l.length)return{loading:!1,value:l};const F=r.current[n];return Array.isArray(F)?{loading:!1,value:F}:q},O=(e,n)=>{const{setFilters:l}=_();j.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:q,filterSelectedOptions:p,limitTags:F,multiple:o}=e,[S,D]=j.useState("");O(t,l);const V=typeof r=="function"?r:void 0,T=typeof r=="function"?void 0:r?.map(m=>x(m)),{value:C,loading:c}=L(V,S,T,u),{filters:d,setFilters:I}=_(),v=x(d[t]),E=j.useMemo(()=>v||(o?[]:null),[v,o]),M=(m,k)=>{I(R=>{const{[t]:U,...$}=R;return k?{...$,[t]:Array.isArray(k)?k.map(Q=>Q.value):k.value}:{...$}})},A=m=>a.jsx(ie,{...m,name:"search",variant:"outlined",label:q,fullWidth:!0}),N=(m,k)=>m.map((R,U)=>a.jsx(le,{label:R.label,color:"primary",...k({index:U})}));return a.jsx(se,{filterSelectedOptions:p,limitTags:F,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:C||[],loading:c,value:E,onChange:M,onInputChange:(m,k)=>D(k),getOptionLabel:m=>m.label,renderInput:A,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
