import{r as d,j as r,I as v,Y as R}from"./iframe-BNkUY5HA.js";import{s as _,M as N}from"./api-DDWvc9yc.js";import{s as $}from"./translation-Q1os9MKa.js";import{u as j,S as k}from"./SearchContext-BG6Qs4zD.js";import{T as q}from"./TablePagination-DOd7lK4z.js";import{S as b}from"./Grid-T8Evs-aA.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-dAdITyCa.js";import"./lodash-Bpc3Agjj.js";import"./useAsync-B5fuvW4L.js";import"./useMountedState-D6BGeb6K.js";import"./KeyboardArrowRight-B_TwwpCT.js";import"./MenuItem-D8_kh4Jx.js";import"./ListItem-BtLTcDqZ.js";import"./ListContext-i5jXFFIx.js";import"./TableCell-DelD9NLj.js";import"./Select-Cm18jZN-.js";import"./index-B9sM2jn7.js";import"./Popover-DFC8wnp9.js";import"./Modal-BKtoBYKW.js";import"./Portal-DQf1B4dl.js";import"./List-Dwb4XmJ7.js";import"./formControlState-AeCIKk_8.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),I=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>I(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
