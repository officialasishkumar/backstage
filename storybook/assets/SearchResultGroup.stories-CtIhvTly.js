import{j as e,Y as D,r as s}from"./iframe-D9Y8dNt-.js";import{S as n,D as o,a as A,b as L}from"./InsertDriveFile-BKv-7-Ai.js";import{s as F,M as C}from"./api-DlUch_na.js";import{c as W}from"./SearchResult-saBsF5AM.js";import{S as j}from"./Grid-ta46I7or.js";import{S as T}from"./SearchContext-BAzDDuuI.js";import{M as w}from"./MenuItem-Z9D3XAhl.js";import{L as Q}from"./ListItemText-CKifMqzR.js";import{L as b}from"./ListItem-CSMdPZ-4.js";import{L as _}from"./ListItemIcon-DnA022zm.js";import{H as N}from"./DefaultResultListItem-DVguYOQK.js";import{w as M,c as E}from"./appWrappers-CN6V1Awt.js";import{c as O}from"./Plugin-BpoOtCjS.js";import{L as H}from"./Link-CX6fYxme.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CCRWdV9i.js";import"./Add-tSIphdtC.js";import"./ArrowForwardIos-DyF5TGAz.js";import"./translation-BpBlp1DL.js";import"./makeStyles-BoqHtulH.js";import"./List-mUIJSmYE.js";import"./ListContext-xNPrKmTk.js";import"./ListSubheader-w623r7up.js";import"./Chip-qnngnwy0.js";import"./Select-CfaJeSHK.js";import"./index-B9sM2jn7.js";import"./Popover-BKRwm4sM.js";import"./Modal-71NnHFAX.js";import"./Portal-DVsLpO23.js";import"./formControlState-XJIDXpR9.js";import"./useAnalytics-CX_WCi2s.js";import"./EmptyState-DyXuFihN.js";import"./Progress-BEHAA0IT.js";import"./LinearProgress-DpBoLb1E.js";import"./Box-BTwSaOGu.js";import"./styled-BgGpovFM.js";import"./ResponseErrorPanel-DgjE292y.js";import"./ErrorPanel-MHQ-AezQ.js";import"./WarningPanel-CW8xElMR.js";import"./ExpandMore-Dk-IyulX.js";import"./AccordionDetails-Cf0o6NFX.js";import"./Collapse-BLz0_YoS.js";import"./MarkdownContent-BVwCvq0M.js";import"./CodeSnippet-CZ92bXRb.js";import"./CopyTextButton-BSG1bAcB.js";import"./useCopyToClipboard-4lPsz2vG.js";import"./useMountedState-B-arlFCl.js";import"./Tooltip-Dx1D_B-m.js";import"./Popper-BSGP2tv0.js";import"./Divider-DmDI7hoL.js";import"./useAsync-D9Cc9Vp-.js";import"./lodash-h7tafzQQ.js";import"./useElementFilter-B-YX9Y-o.js";import"./componentData-BVVUJjR2.js";import"./WebStorage-0dpj7iaf.js";import"./isSymbol-DYihM2bc.js";import"./isObject--vsEa_js.js";import"./toString-jlmj72dF.js";import"./index-C1uQgXas.js";import"./useObservable-CgBswJiJ.js";import"./useIsomorphicLayoutEffect-BjXjpzjp.js";import"./AppThemeApi-1AtRSy4c.js";import"./useApp-jISuD9D7.js";import"./BUIProvider-Cr5RdwXf.js";import"./openLink-CijSEPaD.js";import"./useRouteRef-CNVhFF-b.js";import"./index-BX5foZ21.js";const J=E({id:"storybook.search.results.group.route"}),V=new C({results:[{type:"techdocs",document:{location:"search/search-result1",title:"Search Result 1",text:"Some text from the search result 1"}},{type:"custom",document:{location:"search/search-result2",title:"Search Result 2",text:"Some text from the search result 2"}}]}),ct={title:"Plugins/Search/SearchResultGroup",component:n,decorators:[t=>M(e.jsx(D,{apis:[[F,V]],children:e.jsx(j,{container:!0,direction:"row",children:e.jsx(j,{item:!0,xs:12,children:e.jsx(t,{})})})}),{mountedRoutes:{"/":J}})],tags:["!manifest"]},a=()=>e.jsx(T,{children:e.jsx(n,{icon:e.jsx(o,{}),title:"Documentation"})}),u=()=>{const[t]=s.useState({types:["techdocs"]});return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation"})},l=()=>{const[t]=s.useState({types:["techdocs"]});return e.jsx(D,{apis:[[F,{query:()=>new Promise(()=>{})}]],children:e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation"})})},p=()=>{const[t]=s.useState({types:["techdocs"]});return e.jsx(D,{apis:[[F,{query:()=>new Promise(()=>{throw new Error})}]],children:e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation"})})},m=()=>{const[t]=s.useState({types:["custom"]});return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Custom",titleProps:{color:"secondary"}})},d=()=>{const[t]=s.useState({types:["custom"]});return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Custom",link:"See all custom results",linkProps:{to:"/custom"}})},h=()=>{const[t,c]=s.useState({types:["software-catalog"]}),i=[{label:"Lifecycle",value:"lifecycle"},{label:"Owner",value:"owner"}],x=s.useCallback(r=>()=>{c(I=>{const{filters:g,...q}=I,v={...g,[r]:void 0};return{...q,filters:v}})},[]),k=s.useCallback(r=>I=>{c(g=>{const{filters:q,...v}=g,G={...q,[r]:I};return{...v,filters:G}})},[]),P=s.useCallback(r=>()=>{c(I=>{const{filters:g,...q}=I,v={...g};return delete v[r],{...q,filters:v}})},[]);return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation",filterOptions:i,renderFilterOption:r=>e.jsx(w,{onClick:x(r.value),children:r.label},r.value),renderFilterField:r=>{switch(r){case"lifecycle":return e.jsxs(L,{label:"Lifecycle",value:t.filters?.lifecycle,onChange:k("lifecycle"),onDelete:P("lifecycle"),children:[e.jsx(w,{value:"production",children:"Production"}),e.jsx(w,{value:"experimental",children:"Experimental"})]},r);case"owner":return e.jsx(A,{label:"Owner",value:t.filters?.owner,onChange:k("owner"),onDelete:P("owner")},r);default:return null}}})},y=()=>{const[t]=s.useState({types:["techdocs"]});return e.jsx(D,{apis:[[F,new C]],children:e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation"})})},S=()=>{const[t]=s.useState({types:["techdocs"]});return e.jsx(D,{apis:[[F,new C]],children:e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation",noResultsComponent:e.jsx(Q,{primary:"No results were found"})})})},Y=t=>{const{icon:c,result:i}=t;return e.jsx(H,{to:i.location,children:e.jsxs(b,{alignItems:"flex-start",divider:!0,children:[c&&e.jsx(_,{children:c}),e.jsx(Q,{primary:i.title,primaryTypographyProps:{variant:"h6"},secondary:i.text})]})})},f=()=>{const[t]=s.useState({types:["custom"]});return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Custom",link:"See all custom results",renderResultItem:({document:c,highlight:i,rank:x})=>e.jsx(Y,{result:c,highlight:i,rank:x},c.location)})},R=()=>{const[t]=s.useState({types:["techdocs"]}),i=O({id:"plugin"}).provide(W({name:"DefaultResultListItem",component:async()=>N}));return e.jsx(n,{query:t,icon:e.jsx(o,{}),title:"Documentation",children:e.jsx(i,{})})};a.__docgenInfo={description:"",methods:[],displayName:"Default"};u.__docgenInfo={description:"",methods:[],displayName:"WithQuery"};l.__docgenInfo={description:"",methods:[],displayName:"Loading"};p.__docgenInfo={description:"",methods:[],displayName:"WithError"};m.__docgenInfo={description:"",methods:[],displayName:"WithCustomTitle"};d.__docgenInfo={description:"",methods:[],displayName:"WithCustomLink"};h.__docgenInfo={description:"",methods:[],displayName:"WithFilters"};y.__docgenInfo={description:"",methods:[],displayName:"WithDefaultNoResultsComponent"};S.__docgenInfo={description:"",methods:[],displayName:"WithCustomNoResultsComponent"};f.__docgenInfo={description:"",methods:[],displayName:"WithCustomResultItem"};R.__docgenInfo={description:"",methods:[],displayName:"WithResultItemExtensions"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{code:`const Default = () => {
  return (
