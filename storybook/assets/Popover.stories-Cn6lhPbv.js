...
`,...v.input.parameters?.docs?.source}}};h.input.parameters={...h.input.parameters,docs:{...h.input.parameters?.docs,source:{code:`const WithRichContent = ({ isOpen, hideArrow, placement }) => (
  <DialogTrigger>
    <Button>Open Popover</Button>
    <Popover isOpen={isOpen} hideArrow={hideArrow} placement={placement}>
...
})`,...v.parameters?.docs?.source}}};const ve=["Default","IsOpen","HideArrow","TopPlacement","RightPlacement","BottomPlacement","LeftPlacement","AllPlacements","AllPlacementsNoArrow","WithRichContent","CustomOffset","NonModal","WithLongContent"];export{d as AllPlacements,g as AllPlacementsNoArrow,m as BottomPlacement,x as CustomOffset,r as Default,p as HideArrow,s as IsOpen,u as LeftPlacement,T as NonModal,l as RightPlacement,c as TopPlacement,v as WithLongContent,h as WithRichContent,ve as __namedExportsOrder};
