import{r as y,aM as k,j as p}from"./iframe-Cfvhm_I_.js";import{c as T}from"./useAnalytics-CdOPkTnF.js";import{g as o}from"./get-co31CHaB.js";import{s as w,D as f}from"./ref-C0VTUPuL.js";import{B as b}from"./Box-TWV5D5e5.js";import{T as q}from"./Tooltip-DafbC9NK.js";import{m as A}from"./makeStyles-Cjp1zSIN.js";const j=T({id:"plugin.catalog.entity-presentation"});function x(e,n){const{kind:t,namespace:s,name:r,title:i,description:a,displayName:h,type:m}=E(e),d=w({kind:t||"unknown",namespace:s||f,name:r||"unknown"}),l=L({kind:t,namespace:s,name:r,context:n}),g=[h,i,l].find(u=>u&&typeof u=="string"),v=[g!==d?d:void 0,m,a].filter(u=>u&&typeof u=="string").join(" | ");return{entityRef:d,primaryTitle:g,secondaryTitle:v||void 0,Icon:void 0}}const c=e=>!!e&&typeof e=="string";function E(e){if(typeof e=="string"){let n=e.indexOf(":");const t=e.indexOf("/");t!==-1&&t<n&&(n=-1);const s=n===-1?void 0:e.slice(0,n),r=t===-1?void 0:e.slice(n+1,t),i=e.slice(Math.max(n+1,t+1));return{kind:s,namespace:r,name:i}}if(typeof e=="object"&&e!==null){const n=[o(e,"kind")].find(c),t=[o(e,"metadata.namespace"),o(e,"namespace")].find(c),s=[o(e,"metadata.name"),o(e,"name")].find(c),r=[o(e,"metadata.title")].find(c),i=[o(e,"metadata.description")].find(c),a=[o(e,"spec.profile.displayName")].find(c),h=[o(e,"spec.type")].find(c);return{kind:n,namespace:t,name:s,title:r,description:i,displayName:a,type:h}}return{}}function L(e){const n=e.kind?.toLocaleLowerCase("en-US")||"unknown",t=e.namespace||f,s=e.name||"unknown",r=e.context?.defaultKind?.toLocaleLowerCase("en-US"),i=e.context?.defaultNamespace?.toLocaleLowerCase("en-US");let a=s;return(i&&t.toLocaleLowerCase("en-US")!==i||t!==f)&&(a=`${t}/${a}`),r&&n.toLocaleLowerCase("en-US")!==r&&(a=`${n}:${a}`),a}function N(e,n,t){const[s,r]=y.useState(e);return y.useEffect(()=>{r(e);const i=n?.subscribe({next:a=>{r(a)},complete:()=>{i?.unsubscribe()}});return()=>{i?.unsubscribe()}},t),s}function I(e,n){const s=k().get(j),r=[s,JSON.stringify(e),JSON.stringify(n||null)],i=y.useMemo(()=>{if(!s){const a=x(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return s.forEntity(typeof e=="string"||"metadata"in e?e:w(e),n)},r);return N(i.snapshot,i.update$,[i])}const S=A(e=>({root:{display:"inline-flex",alignItems:"center",textDecoration:"inherit"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),J=e=>{const{entityRef:n,hideIcon:t,disableTooltip:s,defaultKind:r,defaultNamespace:i}=e,a=S(),{primaryTitle:h,secondaryTitle:m,Icon:d}=I(n,{defaultKind:r,defaultNamespace:i});let l=p.jsx(p.Fragment,{children:h});return l=p.jsxs(b,{component:"span",className:a.root,children:[d&&!t?p.jsx(b,{component:"span",className:a.icon,children:p.jsx(d,{fontSize:"inherit"})}):null,l]}),m&&!s&&(l=p.jsx(q,{enterDelay:1500,title:m,children:l})),l};J.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  namespace: string;
  name: string;
}`,signature:{properties:[{key:"kind",value:{name:"string",required:!0}},{key:"namespace",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},{name:"string"}]},description:""},hideIcon:{required:!1,tsType:{name:"boolean"},description:""},disableTooltip:{required:!1,tsType:{name:"boolean"},description:""},defaultKind:{required:!1,tsType:{name:"string"},description:""},defaultNamespace:{required:!1,tsType:{name:"string"},description:""}}};export{J as E};
