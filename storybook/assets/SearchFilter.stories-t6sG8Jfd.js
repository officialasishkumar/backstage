import{r as k,j as a,N as X,P as q,a1 as Y}from"./iframe-B8N4GvwI.js";import{s as Z,M as ee}from"./api-DaCjTZAh.js";import{l as ne}from"./lodash-BgY7d7CH.js";import{a as ae}from"./useAsync-DfYgaazr.js";import{u as te}from"./useDebounce-DR5t6KNJ.js";import{u as _,S as re}from"./SearchContext-BaT9R6Sl.js";import{A as se}from"./Autocomplete-DDfC52Ez.js";import{C as le}from"./Chip-Bt5uR2Dp.js";import{T as ie}from"./TextField-BmNGfI5P.js";import{s as ue}from"./translation-NmT1VsXB.js";import{m as oe}from"./makeStyles-_6Yu2_YB.js";import{a as G,F as ce}from"./FormLabel-BSI5MyEq.js";import{F as me}from"./FormControlLabel-DAeiZiJC.js";import{C as de}from"./Checkbox-CEuplNfP.js";import{S as pe}from"./Select-90h_GCkU.js";import{S as B}from"./Grid-QaPYXNRs.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-BHUlNS6C.js";import"./useMountedState-BUHmGH1y.js";import"./Popper-Bkk-r00N.js";import"./Portal-DI7AqiTH.js";import"./ListSubheader-_mOI1Nbr.js";import"./Select-CiZfMWdU.js";import"./index-B9sM2jn7.js";import"./Popover-CyULg1bi.js";import"./Modal-D8VPwsry.js";import"./List-0a88D0vi.js";import"./ListContext-Dw62DV8y.js";import"./formControlState-T5pfdaY-.js";import"./InputLabel-uAXBpmxg.js";import"./SwitchBase-Df4bA0LJ.js";import"./Cancel-AoB2l8CE.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-MYHTFpuj.js";import"./styled-DnQPDG99.js";import"./MenuItem-DhG38EBr.js";import"./ListItem-DavGzvU0.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ge(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ve=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ve)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ge(t)}function F(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>F(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=k.useRef({}),u=k.useCallback(async o=>(await e?.(o))?.map(b=>F(b))||[],[e]),[y,d]=ae(u,[n],{loading:!0});if(te(()=>{r.current[n]===void 0&&(r.current[n]=d(n).then(o=>(r.current[n]=o,o)))},t,[d,n]),l.length)return{loading:!1,value:l};const v=r.current[n];return Array.isArray(v)?{loading:!1,value:v}:y},O=(e,n)=>{const{setFilters:l}=_();k.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:y,filterSelectedOptions:d,limitTags:v,multiple:o}=e,[b,V]=k.useState("");O(t,l);const h=typeof r=="function"?r:void 0,S=typeof r=="function"?void 0:r?.map(m=>F(m)),{value:A,loading:c}=L(h,b,S,u),{filters:p,setFilters:D}=_(),g=F(p[t]),x=k.useMemo(()=>g||(o?[]:null),[g,o]),j=(m,f)=>{D(W=>{const{[t]:U,...$}=W;return f?{...$,[t]:Array.isArray(f)?f.map(Q=>Q.value):f.value}:{...$}})},w=m=>a.jsx(ie,{...m,name:"search",variant:"outlined",label:y,fullWidth:!0}),N=(m,f)=>m.map((W,U)=>a.jsx(le,{label:W.label,color:"primary",...f({index:U})}));return a.jsx(se,{filterSelectedOptions:d,limitTags:v,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:A||[],loading:c,value:x,onChange:j,onInputChange:(m,f)=>V(f),getOptionLabel:m=>m.label,renderInput:w,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
