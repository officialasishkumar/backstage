import{r as d,j as r,F as v,W as R}from"./iframe-D7TnLv8A.js";import{s as _,M as N}from"./api-Bck3e3eh.js";import{s as $}from"./translation-BQ6sB8rw.js";import{u as j,S as k}from"./SearchContext-BJC5cRrY.js";import{T as q}from"./TablePagination-Ca2pb1M5.js";import{S as b}from"./Grid-iTO1Arnu.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-Dr039tkm.js";import"./useAsync-BF16R5Yc.js";import"./useMountedState-UFQmEtok.js";import"./useAnalytics-AC0VHxKR.js";import"./KeyboardArrowRight-CWtDWfEy.js";import"./MenuItem-BY4Uox8-.js";import"./ListItem-B56tmsM_.js";import"./ListContext-UWf6-YWs.js";import"./TableCell-BgBiUARd.js";import"./Select-DAo5xCK3.js";import"./index-B9sM2jn7.js";import"./Popover-DquKNcU4.js";import"./Modal-C7Rg7DHg.js";import"./Portal-DYix9A2M.js";import"./List-L4X_xhy8.js";import"./formControlState-DfT0zPdM.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
