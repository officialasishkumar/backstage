...
`,...j.input.parameters?.docs?.source}}};P.input.parameters={...P.input.parameters,docs:{...P.input.parameters?.docs,source:{code:`const Default = () => (
  <Accordion>
...
`,...P.input.parameters?.docs?.source}}};B.input.parameters={...B.input.parameters,docs:{...B.input.parameters?.docs,source:{code:`const DefaultExpanded = () => (
...
})`,...E.input.parameters?.docs?.source}}};const ke=["Default","WithSubtitle","CustomTrigger","DefaultExpanded","GroupSingleOpen","GroupMultipleOpen","AutoBg"];export{E as AutoBg,j as CustomTrigger,P as Default,B as DefaultExpanded,v as GroupMultipleOpen,$ as GroupSingleOpen,y as WithSubtitle,ke as __namedExportsOrder};
