import{j as r}from"./iframe-BwbkeUNF.js";import{G as p}from"./Gauge-Cfo67hul.js";import{B as v}from"./Box-BpqKX1IA.js";import{I as y}from"./InfoCard-CaCBXMcC.js";import{m as b}from"./makeStyles-CGCER2cu.js";const q=b({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:i,subheader:a,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.jsx(v,{className:e==="small"?t.rootSmall:t.root,children:r.jsx(y,{title:i,subheader:a,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0},children:r.jsx(p,{...k,size:e})})})}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
