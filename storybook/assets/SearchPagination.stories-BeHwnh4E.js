import{r as d,j as r,I as v,Y as R}from"./iframe-D9Y8dNt-.js";import{s as _,M as N}from"./api-DlUch_na.js";import{s as $}from"./translation-BpBlp1DL.js";import{u as j,S as k}from"./SearchContext-BAzDDuuI.js";import{T as q}from"./TablePagination-LNA5AYI6.js";import{S as b}from"./Grid-ta46I7or.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-CX_WCi2s.js";import"./lodash-h7tafzQQ.js";import"./useAsync-D9Cc9Vp-.js";import"./useMountedState-B-arlFCl.js";import"./KeyboardArrowRight-DIu8O4ah.js";import"./MenuItem-Z9D3XAhl.js";import"./ListItem-CSMdPZ-4.js";import"./ListContext-xNPrKmTk.js";import"./TableCell-BF49n_NS.js";import"./Select-CfaJeSHK.js";import"./index-B9sM2jn7.js";import"./Popover-BKRwm4sM.js";import"./Modal-71NnHFAX.js";import"./Portal-DVsLpO23.js";import"./List-mUIJSmYE.js";import"./formControlState-XJIDXpR9.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),I=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>I(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
