import{p as L,r as p,j as e}from"./iframe-LAkIJzV-.js";import{M as m,f as d,g as x,a as k,b as v,S as y}from"./Menu-BimyZXjN.js";import{M as j}from"./index-DacU1fu4.js";import{B}from"./BUIProvider-BCBhngHq.js";import{F as h}from"./Flex-y9BS8UJk.js";import{T as S}from"./Text-JADR5Fg7.js";import{B as g}from"./Button-DfPt3wS1.js";import"./preload-helper-PPVm8Dsz.js";import"./Autocomplete-BUb86CE9.js";import"./RSPContexts-tCQiqn1K.js";import"./utils-DQ9JD3Eh.js";import"./useObjectRef-Dnfr9yjY.js";import"./useFocusable-D4TJWCE7.js";import"./openLink-DmaCgHpA.js";import"./useLabels-DyWy5cQr.js";import"./useEvent-0yI9s6G2.js";import"./SelectionManager-BX8J_v8H.js";import"./SelectionIndicator-Bill14MS.js";import"./context-r_P2GL11.js";import"./usePress-DejSSO9x.js";import"./textSelection-DvoLH8jT.js";import"./Hidden-DO4aGUV9.js";import"./useControlledState-nNvxiAMi.js";import"./useLocalizedStringFormatter-O5HEBytX.js";import"./Button-BaVVdilz.js";import"./Label-C-mNv6SM.js";import"./useNumberFormatter-BdRMEm_f.js";import"./useLabel-eIB2nDmT.js";import"./useButton-DrRqNQGM.js";import"./useFocusRing-DA0QhuH0.js";import"./Separator-DZQla1Hc.js";import"./Input-MZTqK3pa.js";import"./useFormReset-Bx2I8NYH.js";import"./useField-C8Q3wRbu.js";import"./Form-CddXkb1B.js";import"./ListBox-DVoZE-cC.js";import"./Text-Co4T9G0P.js";import"./useListState-hkhw1Pde.js";import"./Dialog-Cyk1NHXq.js";import"./OverlayArrow-CzwPp9Ep.js";import"./animation-Dz9T6uaO.js";import"./VisuallyHidden-Csn6CGfQ.js";import"./SearchField-NC2Sk7BN.js";import"./FieldError-DeW8slCn.js";import"./Virtualizer-CsJ4LGKP.js";import"./index-C-MtO-sF.js";import"./linkUtils-tKDL5Jm1.js";import"./getNodeText-eneNsEje.js";import"./useFilter-DOuytZjq.js";const M=L.meta({title:"Backstage UI/MenuAutocompleteListBox",component:m,decorators:[n=>e.jsx(j,{children:e.jsx(B,{children:e.jsx(n,{})})})]}),i=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Blueberry",value:"blueberry"},{label:"Cherry",value:"cherry"},{label:"Durian",value:"durian"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],o=M.story({args:{children:null},render:()=>{const[n,r]=p.useState(new Set([i[2].value]));return e.jsxs(h,{direction:"column",gap:"2",align:"start",children:[e.jsxs(S,{children:["Selected: ",Array.from(n).join(", ")]}),e.jsxs(m,{isOpen:!0,children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsx(d,{selectedKeys:n,onSelectionChange:r,children:i.map(t=>e.jsx(x,{id:t.value,children:t.label},t.value))})]})]})}}),s=M.story({args:{...o.input.args},render:()=>{const[n,r]=p.useState(new Set([i[2].value]));return e.jsxs(h,{direction:"column",gap:"2",align:"center",children:[e.jsxs(S,{children:["Selected: ",Array.from(n).join(", ")]}),e.jsxs(m,{children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsx(d,{selectedKeys:n,onSelectionChange:r,children:i.map(t=>e.jsx(x,{id:t.value,children:t.label},t.value))})]})]})}}),a=M.story({args:{...o.input.args},render:()=>{const[n,r]=p.useState(new Set([i[2].value,i[3].value]));return e.jsxs(h,{direction:"column",gap:"2",align:"center",children:[e.jsxs(S,{children:["Selected: ",Array.from(n).join(", ")]}),e.jsxs(m,{children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsx(d,{selectionMode:"multiple",selectedKeys:n,onSelectionChange:r,children:i.map(t=>e.jsx(x,{id:t.value,children:t.label},t.value))})]})]})}}),u=M.story({args:{...o.input.args},render:()=>{const[n,r]=p.useState(new Set([i[2].value]));return e.jsxs(h,{direction:"column",gap:"2",align:"start",children:[e.jsxs(S,{children:["Selected: ",Array.from(n).join(", ")]}),e.jsxs(m,{isOpen:!0,children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsxs(k,{children:[e.jsx(v,{children:"Edit"}),e.jsx(v,{children:"Duplicate"}),e.jsxs(y,{children:[e.jsx(v,{children:"Submenu"}),e.jsx(d,{selectedKeys:n,onSelectionChange:r,placement:"right top",children:i.map(t=>e.jsx(x,{id:t.value,children:t.label},t.value))})]})]})]})]})}}),l=M.story({args:{...o.input.args},render:()=>{const[n,r]=p.useState([]);return p.useEffect(()=>{fetch("https://pokeapi.co/api/v2/pokemon?limit=1000").then(t=>t.json()).then(t=>{r(t.results)}).catch(t=>{console.error("Error fetching Pokemon:",t)})},[]),e.jsxs(m,{isOpen:!0,children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsx(d,{items:n,placeholder:"Search Pokemon...",virtualized:!0,children:n.map((t,b)=>e.jsx(x,{id:t.name,children:t.name.charAt(0).toLocaleUpperCase("en-US")+t.name.slice(1)},b))})]})}}),c=M.story({args:{...o.input.args},render:()=>{const[n,r]=p.useState([]);return p.useEffect(()=>{fetch("https://pokeapi.co/api/v2/pokemon?limit=1000").then(t=>t.json()).then(t=>{r(t.results)}).catch(t=>{console.error("Error fetching Pokemon:",t)})},[]),e.jsxs(m,{isOpen:!0,children:[e.jsx(g,{"aria-label":"Menu",children:"Menu"}),e.jsx(d,{items:n,placeholder:"Search Pokemon...",virtualized:!0,maxHeight:"300px",children:n.map((t,b)=>e.jsx(x,{id:t.name,children:t.name.charAt(0).toLocaleUpperCase("en-US")+t.name.slice(1)},b))})]})}});o.input.parameters={...o.input.parameters,docs:{...o.input.parameters?.docs,source:{code:`const Default = () => {
...
`,...o.input.parameters?.docs?.source}}};s.input.parameters={...s.input.parameters,docs:{...s.input.parameters?.docs,source:{code:`const PreviewListbox = () => {
  const [selected, setSelected] = useState<Selection>(
    new Set([options[2].value])
  );
...
`,...s.input.parameters?.docs?.source}}};a.input.parameters={...a.input.parameters,docs:{...a.input.parameters?.docs,source:{code:`const PreviewListboxMultiple = () => {
  const [selected, setSelected] = useState<Selection>(
...
})`,...c.input.parameters?.docs?.source}}};const Le=["Default","PreviewListbox","PreviewListboxMultiple","Submenu","Virtualized","VirtualizedMaxHeight"];export{o as Default,s as PreviewListbox,a as PreviewListboxMultiple,u as Submenu,l as Virtualized,c as VirtualizedMaxHeight,Le as __namedExportsOrder};
