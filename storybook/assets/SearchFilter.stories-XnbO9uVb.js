import{r as k,j as a,L as X,P as q,a0 as Y}from"./iframe-CIiIDGZ-.js";import{s as Z,M as ee}from"./api-DMxmjj-C.js";import{l as ne}from"./lodash-BzBabpH3.js";import{a as ae}from"./useAsync-B0vM_d2B.js";import{u as te}from"./useDebounce-D_bDTiIl.js";import{u as _,S as re}from"./SearchContext-CexzgwQn.js";import{A as se}from"./Autocomplete-CPAnvqDz.js";import{C as le}from"./Chip-Bepwygrr.js";import{T as ie}from"./TextField-BkvBjJXG.js";import{s as ue}from"./translation-Dw9GzLTE.js";import{m as oe}from"./makeStyles-DIRFdalX.js";import{a as G,F as ce}from"./FormLabel-BphlmPUO.js";import{F as me}from"./FormControlLabel-D-RZE1iT.js";import{C as de}from"./Checkbox-L6nJX3rR.js";import{S as pe}from"./Select-CJ0JljKO.js";import{S as B}from"./Grid-Zain3HUl.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-C8Elrazu.js";import"./useMountedState-IAzCyzSD.js";import"./Popper-COve1U5T.js";import"./Portal-BkGhIEsM.js";import"./ListSubheader-BAngZAI5.js";import"./Select-CxH9X0Ne.js";import"./index-B9sM2jn7.js";import"./Popover-AKQjLAsz.js";import"./Modal-Do_LRYub.js";import"./List-BGk_33Kg.js";import"./ListContext-C8freVI4.js";import"./formControlState-DgIJ0A_f.js";import"./InputLabel-DZZOgupi.js";import"./SwitchBase-CZxqRhbR.js";import"./Cancel-BgLnO6Tz.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-DtVUycxx.js";import"./styled-CIZpuVc6.js";import"./MenuItem-D0zWGv1t.js";import"./ListItem-CqGsN4UV.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ge(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ve=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ve)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ge(t)}function F(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>F(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=k.useRef({}),u=k.useCallback(async o=>(await e?.(o))?.map(b=>F(b))||[],[e]),[y,d]=ae(u,[n],{loading:!0});if(te(()=>{r.current[n]===void 0&&(r.current[n]=d(n).then(o=>(r.current[n]=o,o)))},t,[d,n]),l.length)return{loading:!1,value:l};const v=r.current[n];return Array.isArray(v)?{loading:!1,value:v}:y},O=(e,n)=>{const{setFilters:l}=_();k.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:y,filterSelectedOptions:d,limitTags:v,multiple:o}=e,[b,V]=k.useState("");O(t,l);const h=typeof r=="function"?r:void 0,S=typeof r=="function"?void 0:r?.map(m=>F(m)),{value:A,loading:c}=L(h,b,S,u),{filters:p,setFilters:D}=_(),g=F(p[t]),x=k.useMemo(()=>g||(o?[]:null),[g,o]),j=(m,f)=>{D(W=>{const{[t]:U,...$}=W;return f?{...$,[t]:Array.isArray(f)?f.map(Q=>Q.value):f.value}:{...$}})},w=m=>a.jsx(ie,{...m,name:"search",variant:"outlined",label:y,fullWidth:!0}),N=(m,f)=>m.map((W,U)=>a.jsx(le,{label:W.label,color:"primary",...f({index:U})}));return a.jsx(se,{filterSelectedOptions:d,limitTags:v,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:A||[],loading:c,value:x,onChange:j,onInputChange:(m,f)=>V(f),getOptionLabel:m=>m.label,renderInput:w,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
