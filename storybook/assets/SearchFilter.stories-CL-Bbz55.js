import{r as k,j as a,N as X,P as q,a1 as Y}from"./iframe-DVcxdhoL.js";import{s as Z,M as ee}from"./api-CVPmbsJ-.js";import{l as ne}from"./lodash-BarMUI2a.js";import{a as ae}from"./useAsync-DDYGRsJF.js";import{u as te}from"./useDebounce-D63rGT5M.js";import{u as _,S as re}from"./SearchContext-C94a5PFy.js";import{A as se}from"./Autocomplete-CsALLe6V.js";import{C as le}from"./Chip-D9Lo0rph.js";import{T as ie}from"./TextField-BI6wR-KB.js";import{s as ue}from"./translation-CNiRLzjf.js";import{m as oe}from"./makeStyles-DvhSq6P6.js";import{a as G,F as ce}from"./FormLabel-CdfVBwJA.js";import{F as me}from"./FormControlLabel-B8JC_jUQ.js";import{C as de}from"./Checkbox-D9v5xJ3g.js";import{S as pe}from"./Select-CBpB51o3.js";import{S as B}from"./Grid-Dms4qLVU.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-D67wwHSJ.js";import"./useMountedState-CYBBtHKr.js";import"./Popper-C6RVnZCX.js";import"./Portal-CN0zdblU.js";import"./ListSubheader-ByciUMip.js";import"./Select-DPyy2uBS.js";import"./index-B9sM2jn7.js";import"./Popover-C4IDm9xH.js";import"./Modal-44qXCa1H.js";import"./List-DXUnol4x.js";import"./ListContext-w1A3oPfR.js";import"./formControlState-DUKLu-HT.js";import"./InputLabel-DTqFF-3k.js";import"./SwitchBase-BNNWW9R5.js";import"./Cancel-2-j6oa3H.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-CEEtJDX_.js";import"./styled-CFG22yA2.js";import"./MenuItem-CaVVfr4W.js";import"./ListItem-BwR4C4uD.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ge(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ve=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ve)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ge(t)}function F(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>F(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=k.useRef({}),u=k.useCallback(async o=>(await e?.(o))?.map(b=>F(b))||[],[e]),[y,d]=ae(u,[n],{loading:!0});if(te(()=>{r.current[n]===void 0&&(r.current[n]=d(n).then(o=>(r.current[n]=o,o)))},t,[d,n]),l.length)return{loading:!1,value:l};const v=r.current[n];return Array.isArray(v)?{loading:!1,value:v}:y},O=(e,n)=>{const{setFilters:l}=_();k.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:y,filterSelectedOptions:d,limitTags:v,multiple:o}=e,[b,V]=k.useState("");O(t,l);const h=typeof r=="function"?r:void 0,S=typeof r=="function"?void 0:r?.map(m=>F(m)),{value:A,loading:c}=L(h,b,S,u),{filters:p,setFilters:D}=_(),g=F(p[t]),x=k.useMemo(()=>g||(o?[]:null),[g,o]),j=(m,f)=>{D(W=>{const{[t]:U,...$}=W;return f?{...$,[t]:Array.isArray(f)?f.map(Q=>Q.value):f.value}:{...$}})},w=m=>a.jsx(ie,{...m,name:"search",variant:"outlined",label:y,fullWidth:!0}),N=(m,f)=>m.map((W,U)=>a.jsx(le,{label:W.label,color:"primary",...f({index:U})}));return a.jsx(se,{filterSelectedOptions:d,limitTags:v,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:A||[],loading:c,value:x,onChange:j,onInputChange:(m,f)=>V(f),getOptionLabel:m=>m.label,renderInput:w,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
