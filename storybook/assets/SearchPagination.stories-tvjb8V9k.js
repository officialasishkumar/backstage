import{r as d,j as r,N as v,a2 as N}from"./iframe-DbF3iEvf.js";import{s as R,M as _}from"./api-CF4rG4kv.js";import{s as $}from"./translation-DtxKlnPr.js";import{u as j,S as k}from"./SearchContext-BIX8hsyG.js";import{T as q}from"./TablePagination-DAcGhO45.js";import{S as b}from"./Grid-CVypMrLh.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-CMjFjhus.js";import"./lodash-C-McvsBm.js";import"./useAsync-CMcTC1HS.js";import"./useMountedState-ETLXQmd3.js";import"./KeyboardArrowRight-wNJXo09v.js";import"./MenuItem-Cb08Jwc_.js";import"./ListItem-BXU8AvHT.js";import"./ListContext-CAU0vplw.js";import"./TableCell-C1bKh_aj.js";import"./Select-In3L3hho.js";import"./index-B9sM2jn7.js";import"./Popover-vZsHaVBW.js";import"./Modal-B0_egNjV.js";import"./Portal-hbPr6RYI.js";import"./List-jjp85zn8.js";import"./formControlState-BvqBitRq.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
...
@public`,methods:[],displayName:"SearchPagination"};const ne={title:"Plugins/Search/SearchPagination",component:u,decorators:[e=>r.jsx(N,{apis:[[R,new _]],children:r.jsx(k,{children:r.jsx(b,{container:!0,direction:"row",children:r.jsx(b,{item:!0,xs:12,children:r.jsx(e,{})})})})})],tags:["!manifest"]},t=()=>r.jsx(u,{}),a=()=>r.jsx(u,{limitLabel:"Rows per page:"}),o=()=>r.jsx(u,{limitText:({from:e,to:s})=>`${e}-${s} of more than ${s}`}),n=()=>r.jsx(u,{limitOptions:[5,10,20]});t.__docgenInfo={description:"",methods:[],displayName:"Default"};a.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitLabel"};o.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitText"};n.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitOptions"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{code:`const Default = () => {
