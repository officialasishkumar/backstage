import{j as e,h}from"./iframe-DIo-SVbu.js";import{m as l}from"./makeStyles-DQU7Dv0P.js";import"./preload-helper-PPVm8Dsz.js";const p=l(n=>({alpha:{color:n.palette.common.white,fontFamily:"serif",fontWeight:"normal",fontStyle:"italic"},beta:{color:"#4d65cc",fontFamily:"serif",fontWeight:"normal",fontStyle:"italic"}}),{name:"BackstageLifecycle"});function o(n){const i=p(n),{shorthand:d,alpha:c}=n;return d?e.jsx(h,{component:"span",className:i[c?"alpha":"beta"],style:{fontSize:"120%"},children:c?e.jsx(e.Fragment,{children:"α"}):e.jsx(e.Fragment,{children:"β"})}):e.jsx(h,{component:"span",className:i[c?"alpha":"beta"],children:c?"Alpha":"Beta"})}o.__docgenInfo={description:"",methods:[],displayName:"Lifecycle",props:{shorthand:{required:!1,tsType:{name:"boolean"},description:""},alpha:{required:!1,tsType:{name:"boolean"},description:""}}};const y={title:"Feedback/Lifecycle",component:o,tags:["!manifest"]},a=()=>e.jsxs(e.Fragment,{children:["This feature is in ",e.jsx(o,{alpha:!0})]}),s=()=>e.jsxs(e.Fragment,{children:["This feature is in ",e.jsx(o,{alpha:!0,shorthand:!0})]}),r=()=>e.jsxs(e.Fragment,{children:["This feature is in ",e.jsx(o,{})]}),t=()=>e.jsxs(e.Fragment,{children:["This feature is in ",e.jsx(o,{shorthand:!0})]});a.__docgenInfo={description:"",methods:[],displayName:"AlphaDefault"};s.__docgenInfo={description:"",methods:[],displayName:"AlphaShorthand"};r.__docgenInfo={description:"",methods:[],displayName:"BetaDefault"};t.__docgenInfo={description:"",methods:[],displayName:"BetaShorthand"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{code:`const AlphaDefault = () => (
  <>
