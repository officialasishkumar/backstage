import{r as i,c as u,j as t,b as o}from"./iframe-BPVPwWzn.js";import{u as c,a as p,b as m}from"./index-ClPDwBGK.js";import{$ as l}from"./openLink-Bc-74F4f.js";function b(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(g,{children:r}):r}function g({children:n}){const e=p();return t.jsx(l,{navigate:e,useHref:m,children:n})}b.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
