import{r as a,j as i}from"./iframe-_E948MVz.js";import{e as y,a as f}from"./routes-CjyYf-91.js";import{u as m}from"./useRouteRef-CF-IsBln.js";import{E as g}from"./EntityDisplayName-DTBv1vPu.js";import{L as b}from"./Link-yJri3-iz.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(g,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(b,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=m(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
